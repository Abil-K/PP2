...
while not done:
    ...
    blitRotate(screen, get_image("images/rightarm.png"), pos, angle_sec)  # Right arm shows seconds
    blitRotate(screen, get_image("images/leftarm.png"), pos, angle_min)  # Left arm shows minutes
