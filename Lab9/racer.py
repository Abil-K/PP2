...
player_img = pygame.image.load('Lab9/images/Player.png')
enemy_img = pygame.image.load('Lab9/images/Enemy.png')
coin_img = pygame.image.load('Lab9/images/coin.png')

background_music = pygame.mixer.music.load('Lab9/sound/background.wav')
crash_sound = pygame.mixer.Sound('Lab9/sound/crash.wav')
